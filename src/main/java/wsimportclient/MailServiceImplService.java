 ...
 * 
 */
@WebServiceClient(name = "MailServiceImplService", targetNamespace = "http://soap.webservices/", wsdlLocation = "http://localhost:8082/soap/mailService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName MAILSERVICEIMPLSERVICE_QNAME = new QName("http://soap.webservices/", "MailServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8082/soap/mailService?wsdl");
    ...
    public MailService getMailServiceImplPort() {
        return super.getPort(new QName("http://soap.webservices/", "MailServiceImplPort"), MailService.class);
    }
    ...
    public MailService getMailServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://soap.webservices/", "MailServiceImplPort"), MailService.class, features);
    }
